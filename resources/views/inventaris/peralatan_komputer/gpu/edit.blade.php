                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-12  col-sm-12">
                            <form action="{{ url('ubah/inventaris-peralatan-komputer/gpu/'.$data->id) }}"
                                method="post">
                                @csrf
                                @method("PUT")
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ $data->namaGpu }}" type="text" name="nama_gpu" class="form-control" required>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3 col-6">
                                        ...
                                        <div class="input-group">
                                            <input value="{{ $data->ukuranMemori }}" type="text" name="ukuran_memori_gpu" class="form-control" required>
                                    ...
                                    <div class="form-group col-md-3 col-6">
                                        ...
                                        <input type="text" value="{{ $data->tipeMemori }}" name="tipe_memori_gpu" class="form-control" required>
