                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-12  col-sm-12">
                            <form action="{{ url('ubah/inventaris-peralatan-komputer/storage/'.$data->id) }}"
                                method="post">
                                @csrf
                                @method("PUT")
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $data->namaStorage }}" name="nama_storage" class="form-control">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="jenis_storage" id="" class="form-control">
                                                @if ($data->jenisStorage == "HDD")
                                                <option value="HDD">HDD</option>
                                                <option value="NVME">NVME</option>
                                                <option value="SSD">SSD</option>
                                                @elseif ($data->jenisStorage == "NVME")
                                                <option value="NVME">NVME</option>
                                                <option value="HDD">HDD</option>
                                                <option value="SSD">SSD</option>
                                                @else
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input value="{{ $data->kapasitasStorage }}" type="number" min="1" name="kapasitas_storage"
