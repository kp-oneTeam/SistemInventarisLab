                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-12  col-sm-12">
                            <form action="{{ url('ubah/inventaris-peralatan-komputer/casing/'.$data->id) }}"
                                method="post">
                                @csrf
                                @method("PUT")
                                ...
                                <div class="form-group">
                                    ...
                                    <input  type="text" value="{{ $data->namaCasing }}" name="nama_casing" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <select  name="form_factor_casing" class="form-control select2" required>
                                        ...
                                        @endphp
                                        <option value="{{ $data->formFactor }}" selected>{{ $data->formFactor }}<option>
